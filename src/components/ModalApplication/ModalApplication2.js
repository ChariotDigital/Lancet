...
const ModalApplication = (props) => {
  ...
  return (
    <>
      <ModalStyled {...props} size="lg" centered show={gContext.applicationModalVisible} onHide={gContext.toggleApplicationModal} className="mb-5">
              ...
              <div className="bg-white rounded-4 overflow-auto h-1173">
                ...
                <div className="pr-xl-0 pr-xxl-14 p-5 px-xs-12 pt-7 pb-5">
                  ...
                  <p className="font-size-4 mb-8">
                    A talented professional with an academic background in IT and proven commercial development experience as C++ developer since 1999. Has a sound knowledge of the
                    software development life cycle. Was involved in more than 140 software development outsourcing projects.
                  </p>
