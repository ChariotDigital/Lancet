  ...
  console.log(props)
    return (
        <div className="w-100">
          ...
          <p>
          {props.service.attributes.description}
            </p>
        </div>
    )
}
