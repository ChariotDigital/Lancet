          ...
          <div className="row align-items-center justify-content-center">
            ...
            <div className="col-12 col-xl-6 col-lg-7 col-md-9">
              <div className="text-center mb-12 mb-lg-17">
                ...
                <p className="font-size-5 px-5 px-lg-7 px-xl-9 px-xxl-15 mb-6">Leverage agile frameworks to provide a robust synopsis for high level overviews to start.</p>
              </div>
            </div>
          </div>
          {/* <!-- End Section Top --> */}
          <div className="row justify-content-center" data-aos="fade-right" data-aos-duration="800">
            {/* <!-- Single Category --> */}
          ...
          <div className="row">
            <div className="col-12">
              <div className="text-center pt-5 pt-lg-13">
                <Link href="/search-grid">
                  <a className="btn btn-outline-black-2 btn-lg text-uppercase">Explore All</a>
                </Link>
              </div>
            </div>
          </div>
