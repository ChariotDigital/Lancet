      ...
      <div className="position-relative z-index-1 bg-squeeze pt-26 dark-mode-texts">
        ...
        <div className="container position-static">
          <div className="row position-relative align-items-center position-static">
            <div className="col-xxl-7 col-xl-8 col-lg-9 pt-lg-23 pb-lg-33 pb-md-28 pb-xs-26 pb-29 pt-md-20" data-aos="fade-right" data-aos-duration="800" data-aos-delay="500">
              <div className="row">
            ...
            <div className="col-lg-11 col-12 translateY-50 pos-abs-bl">
              <form action="/" className="search-form" data-aos="fade-up" data-aos-duration="800" data-aos-delay="500">
                <div className="filter-search-form-2 bg-white rounded-sm shadow-7 pr-8 py-7 pl-6">
                  ...
                  <div className="button-block">
                    <Link href="/search-grid">
                      <Button type="submit" className="line-height-reset h-100 btn-submit w-100 text-uppercase">
                        Search
                      </Button>
                    </Link>
                  </div>
